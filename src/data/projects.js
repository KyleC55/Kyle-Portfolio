export const projects = [
  ...
  },
  {
    ...
    description:
      "Curated and annotated a ~1,000-problem multi-label dataset and evaluated text classification models for prompt routing.",
    highlights: [
      "Compared BERT-based and character-level CNN models on formula-heavy text.",
      "Analyzed per-label performance to identify model strengths and tradeoffs.",
    ],
    links: [{ label: "GitHub", href: "https://github.com/KyleC55", type: "github" }],
  },
  {
